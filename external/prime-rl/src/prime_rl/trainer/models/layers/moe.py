...
try:  # pragma: no cover - optional dependency
    ...
    def expert_parallel(fn):
        def _missing_torchtitan(*args, **kwargs):
            raise ImportError(
                "torchtitan is not installed. MoE layers require the `torchtitan` package. "
                "Install it or avoid using MoE-enabled models."
            )

        return _missing_torchtitan
